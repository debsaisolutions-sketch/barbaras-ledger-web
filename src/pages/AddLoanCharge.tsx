...
export default function AddLoanCharge() {
  ...
  return (
    <div>
      <button className="back-link" onClick={() => navigate(`/loans/${id}`)}>
        ← Back
      </button>
      <div className="page-header">
        <h2>📋 Add Loan Charge</h2>
      </div>
      <div className="card">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g., Interest charge, Additional loan"
            />
          </div>
          <div className="form-group">
            <label>Notes</label>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <button type="button" className="btn btn-outline" onClick={() => navigate(`/loans/${id}`)}>
              Cancel
            </button>
          </div>
        </form>
